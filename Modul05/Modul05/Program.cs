...
namespace Modul05
{
	class MainClass
	{
		...
		public static void cmd01 ( string _input ) //cmd01 5      ---> 5*5 = 25
		{
			try {
				double _temp = 0;
      ...
      public static bool cmd03 ( string _input, out double _i)  //cmd03 45 ---> 45*45  out
{
	try
	{
	...
	return false;
		...
		public static bool cmd04 ( ref double _i )  //ref
		{
			double _temp = _i;
